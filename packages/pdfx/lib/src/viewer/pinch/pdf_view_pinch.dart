...
class _PdfViewPinchState extends State<PdfViewPinch>
  ...
  void _reLayoutDefault(Size viewSize) {
    final maxWidth = _pages.fold<double>(
      0.0,
      (maxWidth, page) => max(maxWidth, page.pageSize.width),
    );
    final ratio = (viewSize.width - _padding * 2) / maxWidth;
    //print('IK. Ratio: $ratio, view size: $viewSize, max pages width: $maxWidth');
    ...
    for (var i = 0; i < _pages.length; i++) {
      ...
      if (page.status == _PdfPageLoadingStatus.initialized) {
        ...
        page
          ...
          ..updatePreview();
        needPagePreviewGeneration = true;
      }
    }
  ...
  final _realSizeOverlayUpdateBufferDuration = const Duration(
    milliseconds: 150,
  );
              ...
              children: [
                ...
                ValueListenableBuilder<int>(
                  ...
                  builder: (context, value, child) {
                    ...
                    return page.realSizeOverlayRect != null &&
                            page.realSize != null
                        ? Positioned(
